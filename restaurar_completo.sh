#!/bin/bash
# Script de restauração completa - corrige o erro de importação e substitui main.py
...
mkdir -p "$BACKUP_DIR"
cp core/*.py "$BACKUP_DIR/" 2>/dev/null || true
echo "✅ Backup criado em $BACKUP_DIR"

# Garantir que __init__.py existe
touch core/__init__.py
echo "✅ core/__init__.py verificado/criado"

# Substituir main.py pela versão estável
...
echo "✅ main.py substituído pela versão estável."
