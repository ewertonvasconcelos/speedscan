...
class SpeedScan(ctk.CTk):
    ...
    def __init__(self):
        ...
        print("DEBUG: SpeedScan.__init__ finalizado")
    ...
    def _build_sidebar(self):
        print("DEBUG: _build_sidebar iniciado")
    ...
    def show_frame(self, target):
        print(f"DEBUG: show_frame chamado com target={target}")
    ...
    def _fill_dashboard(self, parent):
        print("DEBUG: _fill_dashboard executado")
    ...
    def _fill_optimization(self, parent):
        print("DEBUG: _fill_optimization executado")
    ...
    def _fill_network(self, parent):
        print("DEBUG: _fill_network executado")
    ...
    def _fill_drivers(self, parent):
        print("DEBUG: _fill_drivers executado")
        """Drivers tab."""
        ctk.CTkLabel(
            parent,
            text=self._("Drivers"),
    ...
    def _fill_processes(self, parent):
        print("DEBUG: _fill_processes executado")
        """Process manager tab."""
        ctk.CTkLabel(
            parent,
    ...
    def _fill_history(self, parent):
        print("DEBUG: _fill_history executado")
    ...
    def _fill_security(self, parent):
        print("DEBUG: _fill_security executado")
        """Security tab."""
        ctk.CTkLabel(
            parent,
    ...
    def _fill_agent(self, parent):
        print("DEBUG: _fill_agent executado")
        """AI Agent chat tab."""
        ctk.CTkLabel(
            parent,
    ...
    def _fill_settings(self, parent):
        print("DEBUG: _fill_settings executado")
        """Settings tab."""
        ctk.CTkLabel(
            parent,
    ...
    def _fill_about(self, parent):
        print("DEBUG: _fill_about executado")
        """About tab."""
        ctk.CTkLabel(
            parent,
...
© 2026 Ewerton Vasconcelos. {self._("All rights reserved.")}"""
    ...
    def _fill_windows_cleaner(self, parent):
        print("DEBUG: _fill_windows_cleaner executado")
    ...
    def run_card_action(self, cmd, tag, is_dns):
        ...
        # Mostra o botão de detalhes no canto direito se não estiver visível
