...
def get_config():
    ...
    logging.error(f"Exceção em speedscan_app.py:28: {e}")
            pass
    return {
        "theme": "default",
        "username": "ewerton",
...
class SpeedScan(ctk.CTk):
    ...
    logging.error(f"Exceção em speedscan_app.py:139: {e}")
    ...
    logging.error(f"Exceção em speedscan_app.py:335: {e}")
    ...
    logging.error(f"Exceção em speedscan_app.py:348: {e}")
                pass
    ...
    logging.error(f"Exceção em speedscan_app.py:369: {e}")
            pass
    ...
    logging.error(f"Exceção em speedscan_app.py:391: {e}")
            pass
    ...
    logging.error(f"Exceção em speedscan_app.py:406: {e}")
                        continue
            if disks_info:
                return "\n".join(disks_info[:3])
            else:
    ...
    logging.error(f"Exceção em speedscan_app.py:412: {e}")
            return "N/A"
    ...
    logging.error(f"Exceção em speedscan_app.py:419: {e}")
            return "N/A"
    ...
    logging.error(f"Exceção em speedscan_app.py:429: {e}")
            return "AC Power"
    ...
    logging.error(f"Exceção em speedscan_app.py:666: {e}")
    ...
    logging.error(f"Exceção em speedscan_app.py:751: {e}")
    ...
    logging.error(f"Exceção em speedscan_app.py:878: {e}")
    ...
    logging.error(f"Exceção em speedscan_app.py:900: {e}")
            log.insert("end", f"Erro: {e}\n")
    ...
    logging.error(f"Exceção em speedscan_app.py:1142: {e}")
                pass
    ...
    logging.error(f"Exceção em speedscan_app.py:1152: {e}")
                pass
    ...
    logging.error(f"Exceção em speedscan_app.py:1174: {e}")
    ...
    logging.error(f"Exceção em speedscan_app.py:1240: {e}")
            current = ""
    ...
    logging.error(f"Exceção em speedscan_app.py:1317: {e}")
                pass
        elif self.SO == "Windows":
    ...
    logging.error(f"Exceção em speedscan_app.py:1489: {e}")
