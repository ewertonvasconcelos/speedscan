...
backup = Path("core/dashboard.py.bak_fix")
...
for i, linha in enumerate(linhas):
    if 'callback = getattr(self.app, callback_name)' in linha:
        # Substituir por um bloco try-except (sem f-strings aninhadas)
        ...
        novo_bloco = [
            ...
            f'{indent}    print("DEBUG: AttributeError:", e, "self.app type =", type(self.app), "callback_name =", callback_name)\n',
            f'{indent}    print("DEBUG: self.app dir =", dir(self.app)[:10], "...")\n',
