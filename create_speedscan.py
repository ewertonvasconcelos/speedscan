...
class SpeedScan(ctk.CTk):
    ...
    def _kill_selected_process(self):
        """Kill the process currently selected in the text widget."""
        try:
            # Get selected line
    ...
    def _update_graphs(self, choice=None):
        """Update the graphs with data from the database."""
...
© 2026 Ewerton Vasconcelos. {self._("All rights reserved.")}"""
    ...
    def _execute_windows_cleanup(self):
        """Execute selected system tweaks."""
        self.windows_console.delete("1.0", "end")
    ...
    def _run_subprocess(self, cmd, log, use_sudo=False, shell=False):
        """Run a subprocess and pipe output to log."""
        try:
...
# ==================== actions.py ====================
actions_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
class ActionHandler:
    ...
    def _run_linux_command(self, cmd, log, use_sudo=True):
        """Run a command on Linux and pipe output to the log widget."""
    ...
    def run_turbo_mode(self, log):
        log.delete("1.0", "end")
        log.insert("end", "🚀 Activating turbo mode (adjusts governor for performance)...\\n")
        if self.app.SO != "Linux":
            log.insert("end", "⚠️ Operation only for Linux.\\n")
            return
...
def add_tooltip(widget, text):
    """
    Attach a hover tooltip to a customtkinter widget.

    Args:
        widget: CTk widget to attach the tooltip to.
...
def add_console(parent, tag_prefix, acc_color, toggle_callback):
    """
    Add a console (text area) and a button to toggle its visibility.

    Args:
        parent: Parent widget.
        tag_prefix (str): Prefix used in callbacks to identify this console.
        acc_color (str): Color for the button.
        toggle_callback (callable): Function that takes the tag_prefix and toggles the console.

    Returns:
        tuple: (button, text_box) - The created widgets.
    """
...
# List of available widgets with their display name and callback method.
WIDGET_TYPES = [
...
class Dashboard(ctk.CTkFrame):
    ...
    def add_to_slot(self, widget):
        """
        Add a widget to the first slot, shifting the others right and putting the displaced widget
...
# Display names for themes (user-facing)
THEME_DISPLAY_NAMES = {
    "grey": "Still",
    "dark": "Tecno",
    "light": "Snow"
...
# ==================== hardware.py ====================
hardware_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
class HardwareInfo:
    ...
    def get_ram(self):
        ...
        Returns:
            str: Formatted RAM usage string.
        """
        try:
            mem = psutil.virtual_memory()
...
# ==================== health_score.py ====================
health_score_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
temp_monitor_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
# ==================== smart_monitor.py ====================
smart_monitor_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
# ==================== browser_cleaner.py ====================
browser_cleaner_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
class BrowserCleaner:
    """
    Cleans browser data (cache, cookies, history) for Chrome, Firefox, etc.
    """
    def __init__(self):
        self.browsers = {
            "chrome": {
            ...
            "firefox": {
                ...
                "places_file": "places.sqlite"  # history
            },
            "brave": {
                "name": "Brave",
                "cache_paths": [
    ...
    def clean_browser(self, browser_key: str, preserve_cookies: bool = False,
        ...
        """
        Clean cache, cookies, and history for a specific browser.

        Args:
            browser_key (str): Key identifying the browser (e.g., 'chrome').
            preserve_cookies (bool): If True, do not delete cookies.
            cookie_keep_list (list): List of domain names to preserve cookies for (not implemented).

        Returns:
            dict: Summary with 'cache_freed', 'cookies_freed', 'history_freed', 'errors'.
        """
    ...
    def clean_all_browsers(self, preserve_cookies: bool = False,
                           cookie_keep_list: Optional[List[str]] = None) -> Dict:
        """
        Clean all supported browsers.

        Args:
            preserve_cookies (bool): If True, do not delete cookies.
            cookie_keep_list (list): List of domain names to preserve cookies for.

        Returns:
            dict: Combined results per browser.
        """
        results = {}
...
# ==================== speed_test.py ====================
speed_test_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
# ==================== process_manager.py ====================
process_manager_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
class ProcessManager:
    """
    Manages system processes: listing, killing, priority changes, suspending/resuming.
    """
    def __init__(self):
...
historical_metrics_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
class MetricsCollector:
    ...
    def _collect_once(self):
        ...
        try:
            ...
            if int(now) % 3600 < 5:  # around hour change
...
# ==================== lan_scanner.py ====================
lan_scanner_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
class LANScanner:
    ...
    def get_local_network(self) -> Optional[str]:
        ...
        Returns:
            Optional[str]: Network string, or None.
        """
        try:
    ...
    def arp_lookup(self, ip: str) -> Optional[Dict]:
        ...
        Returns:
            Optional[dict]: dict with "ip" and "mac" keys, or None.
        """
        try:
    ...
    def scan_network(self, network_cidr: str = None, progress_callback=None) -> List[Dict]:
        ...
        Args:
            ...
            progress_callback (callable(current, total, ip, is_alive) optional): Called after each ping.
...
# ==================== ai_proactive.py ====================
ai_proactive_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
# ==================== security_scanner.py ====================
security_scanner_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
# ==================== lan_cache.py ====================
lan_cache_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
class ChatFrame(ctk.CTkFrame):
    ...
    def _query_ollama(self, message):
        ...
        try:
            # Build messages from history (excluding system messages)
...
# ==================== cookie_manager.py ====================
cookie_manager_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
class CookieManager:
    ...
    def get_cookies_from_browser(self, browser_key: str) -> List[Dict]:
        ...
        if "*" in str(path):
            # Handle wildcard for Firefox profiles
...
# ==================== trash_manager.py ====================
trash_manager_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
# ==================== windows_cleaner.py ====================
windows_cleaner_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
# ==================== scheduler.py ====================
scheduler_py = '''#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""
...
print("\n✅ Todos os 24 módulos foram criados em core/")
print("\nAgora execute o software com:")
print("  python3 -m core.main")
