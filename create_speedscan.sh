#!/bin/bash
# Script para criar todos os módulos do SpeedScan (versão modular)
# Execute no diretório onde deseja criar a pasta core/

set -e  # Interrompe em caso de erro

echo "Criando pasta core/ ..."
mkdir -p core
...
echo "✅ Todos os 24 módulos foram criados em core/"
echo ""
echo "Agora execute o software com:"
