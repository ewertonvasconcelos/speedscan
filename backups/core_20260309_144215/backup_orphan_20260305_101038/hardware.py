...
class HardwareInfo:
    ...
    logging.error(f"Exceção em hardware.py:25: {e}")
                pass
            return "Linux"
    ...
    logging.error(f"Exceção em hardware.py:46: {e}")
            pass
    ...
    logging.error(f"Exceção em hardware.py:56: {e}")
            return "N/A"
    ...
    logging.error(f"Exceção em hardware.py:76: {e}")
            pass
        return "Desconhecida"
    ...
    logging.error(f"Exceção em hardware.py:111: {e}")
            return "N/A"
    ...
    logging.error(f"Exceção em hardware.py:123: {e}")
            return "N/A"
