...
class TemperatureMonitor:
    ...
    logging.error(f"Exceção em temperature_monitor.py:30: {e}")
                    pass
except Exception as e:
    logging.error(f"Exceção em temperature_monitor.py:32: {e}")
    ...
    logging.error(f"Exceção em temperature_monitor.py:46: {e}")
            pass
        return temps
    ...
    logging.error(f"Exceção em temperature_monitor.py:67: {e}")
            pass
        return temps
