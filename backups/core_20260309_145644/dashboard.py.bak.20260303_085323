...
# Botões maiores para melhor visualização
# Versão 0.0.9-beta
# =============================================================================
...
# Lista completa de widgets disponíveis (11 no total)
WIDGET_TYPES = [
...
class Dashboard(ctk.CTkFrame):
    ...
    def _build_ui(self):
        """Cria os 3 slots e as duas linhas de widgets disponíveis."""
        ...
        # Frame para as duas linhas de botões (centralizado)
    ...
    def _update_available_buttons(self):
        """Recria os botões de widgets disponíveis em duas linhas de 4."""
        # Limpa as linhas
        ...
        # Centraliza os frames horizontalmente
