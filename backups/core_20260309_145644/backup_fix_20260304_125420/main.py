            ...
            try:
                with open(config.CONFIG_FILE) as f:
                    ...
                    if 'window_state' not in config:
                        config['window_state'] = config.DEFAULT_CONFIG['window_state']
                    if 'simple_mode' not in config:
                        config['simple_mode'] = config.DEFAULT_CONFIG['simple_mode']
                    if 'expert_level' not in config:
                        config['expert_level'] = config.DEFAULT_CONFIG['expert_level']
                    if 'ai' not in config:
                        config['ai'] = config.DEFAULT_CONFIG['ai']
                    return config
            except:
                pass
