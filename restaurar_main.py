...
backup = Path("core/main.py.bak_restauracao")
shutil.copy2(arquivo, backup)
print(f"Backup criado: {backup}")

# Conteúdo do novo main.py (versão estável com todos os métodos)
...
class SpeedScan(ctk.CTk):
    ...
    def _resume_selected_process(self):
        try:
            ...
            self.show_toast(self._("Selecione un processo."), duration=2000)
    ...
    def _fill_config(self, parent):
        ...
        theme_names = ["Padrão (Roxo)", "Tecno", "Clean"]
        ...
        elif current_theme == "tecnico":
            self.theme_var.set(theme_names[1])
        elif current_theme == "clean":
        ...
        try:
            ...
            for k,v in config.SCALES.items():
                if v == self.scale_var.get():
                    ...
                    break
            theme_map = {"Padrão (Roxo)": "default", "Tecno": "dark", "Clean": "light"}
    ...
    def _execute_command(self, cmd, log, tag, is_dns):
        if is_dns:
            ...
            # Após DNS, podemos verificar se deve mostrar botão
    ...
    def _run_ping(self, log, tag=None):
        ...
        try:
            # Executa ping por 5 minutos (300 segundos) com intervalo de 1 segundo
...
print("Arquivo main.py restaurado com sucesso.")
