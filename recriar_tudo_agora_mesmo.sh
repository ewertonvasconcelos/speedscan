#!/bin/bash
# Script único para recriar o SpeedScan do zero – versão final

set -e

echo "🚀 Recriando SpeedScan (versão funcional)..."
...
# ==================== Traduções básicas ====================
echo "🌐 Criando arquivos de tradução básicos..."
...
echo ""
echo "🎉 RECRIAÇÃO COMPLETA FINALIZADA!"
echo ""
echo "Agora execute o programa:"
echo "   source venv_distrobox/bin/activate"
