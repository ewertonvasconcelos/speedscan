#!/bin/bash
# Script de instalação completa do SpeedScan - versão final
...
if ! command -v msgfmt >/dev/null 2>&1; then
    echo "📦 Instalando gettext (para traduções)..."
...
# 4. Gerar traduções
# ============================================================
echo "🌐 Gerando arquivos de tradução..."
mkdir -p locale
